...
`docs/FFI.md` contract — 124 symbols at v0.3.4, frozen enums, §8 idiom
gate).
...
> fixtures (267 executable lines across 8 files at v0.3.4 — the 256 the
...
(none yet — the v0.3.4 artifacts verify and the suite is 267/267 green on
them.)
