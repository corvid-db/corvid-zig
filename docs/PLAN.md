...
`docs/FFI.md` contract — 124 symbols at v0.3.3, frozen enums, §8 idiom
gate).
...
> fixtures (267 executable lines across 8 files at v0.3.3 — the 256 the
...
- **Pin EXACT engine tags.** One engine version at a time; today `v0.3.3`.
...
(none yet — the v0.3.3 artifacts verify and the suite is 267/267 green on
them.)
